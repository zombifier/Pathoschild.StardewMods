...
namespace Pathoschild.Stardew.LookupAnything.Framework.Lookups.Buildings
{
    ...
    internal class BuildingLookupProvider : BaseLookupProvider
    {
        ...
        *********/
        ...
        {
            return new BuildingSubject(this.Codex, this.GameHelper, building, building.getSourceRectForMenu() ?? building.getSourceRect(), this.Config().CollapseLargeFields, this.Config().ShowInvalidRecipes);
        }
    }
}
